    ...
    with st.container():
        ...
        if not row.empty:
            ...
            fig.add_trace(go.Indicator(
                ...
                title={'text': 'Bullish %'},
                gauge={'axis': {'range': [0, 100]}, 'bar': {'color': '#2ecc71'}, 'threshold': {'line': {'color': 'gray'}, 'thickness': 4, 'value': 50}},
                domain={'x': [0, 0.32]}
            ), row=1, col=1)
            ...
            fig.add_trace(go.Indicator(
                ...
                title={'text': 'Bearish %'},
                gauge={'axis': {'range': [0, 100]}, 'bar': {'color': '#e74c3c'}, 'threshold': {'line': {'color': 'gray'}, 'thickness': 4, 'value': 50}},
                domain={'x': [0.34, 0.66]}
            ), row=1, col=2)
            ...
            fig.add_trace(go.Indicator(
                ...
                title={'text': 'Sideways %'},
                gauge={'axis': {'range': [0, 100]}, 'bar': {'color': '#f39c12'}, 'threshold': {'line': {'color': 'gray'}, 'thickness': 4, 'value': 50}},
                domain={'x': [0.68, 1.0]}
            ), row=1, col=3)
